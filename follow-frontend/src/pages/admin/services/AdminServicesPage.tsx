...
function getPlatformMeta(platform: string) {
  ...
  if (key.includes("youtube")) {
    return {
      ...
      sectionBorder: "border-red-400/10",
            ...
            {engagementPlatforms.map((item) => {
              ...
              return (
                <motion.button
                  ...
                  onClick={() => navigate(`/admin/services/engagement/${item.key}`)}
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-white/35">
                    Chỉnh giá, nội dung mô tả, min/max và trạng thái gói dịch vụ.
                  </p>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div
                    className={`rounded-full border px-4 py-2 text-xs font-medium uppercase tracking-wide ${meta.badgeClass}`}
                  >
                  ...
                  {platform.services.map((service) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className="group relative min-h-[240px] rounded-[24px] border border-white/8 bg-[#08152d] p-5 text-left transition hover:border-white/14 hover:bg-[#0b1a35]"
                      >
                        ...
                        <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-blue-400/20 bg-blue-400/10 px-3 py-1.5 text-xs font-semibold text-blue-200">
                          <Pencil size={14} />
                          Chỉnh sửa
                        </div>
                      </motion.button>
