        ...
        <div style="max-width:680px;margin:0 auto;background:#0b1730;border:1px solid rgba(255,255,255,0.08);border-radius:24px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.35);">
            ...
            <div style="padding:28px 32px;">
                <div style="margin-bottom:20px;padding:18px 20px;border-radius:18px;background:rgba(47,128,237,0.08);border:1px solid rgba(47,128,237,0.18);">
                    <div style="font-size:13px;color:#8fb8ff;margin-bottom:8px;">Mã đơn nội bộ</div>
                ...
                <div style="margin-bottom:24px;">
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                        <tr>
                            ...
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;font-weight:600;">{{ $order->service_name ?? 'Không có' }}</td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#8ea3c7;">Nền tảng</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;font-weight:600;">{{ $order->platform ?? 'Không có' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;font-weight:600;">{{ $order->quantity ?? 'Không có' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding:12px 0;font-size:14px;color:#8ea3c7;">Comments</td>
                            <td style="padding:12px 0;font-size:14px;color:#ffffff;white-space:pre-line;">
                                {{ $comments ?? 'Không có' }}
                            </td>
                        </tr>
                    </table>
                ...
                <div style="margin-bottom:24px;">
                    <div style="font-size:15px;font-weight:700;color:#ffffff;margin-bottom:14px;">Thông tin external API</div>

                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);width:38%;font-size:14px;color:#8ea3c7;">External Order ID</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;">{{ $externalOrderId }}</td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#8ea3c7;">External Status</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#34d399;font-weight:700;">{{ $externalStatus }}</td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#8ea3c7;">API Charge</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;">{{ $apiCharge }}</td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#8ea3c7;">API Start Count</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;">{{ $apiStartCount }}</td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;font-size:14px;color:#8ea3c7;">API Remains</td>
                            <td style="padding:12px 0;font-size:14px;color:#ffffff;">{{ $apiRemains }}</td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="margin-bottom:24px;padding:18px 20px;border-radius:18px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);">
                    <div style="font-size:14px;font-weight:700;color:#ffffff;margin-bottom:10px;">Raw external response</div>
                    <pre style="margin:0;white-space:pre-wrap;word-break:break-word;font-size:12px;line-height:1.7;color:#c6d4ef;">{{ $rawResponse }}</pre>
                </div>
