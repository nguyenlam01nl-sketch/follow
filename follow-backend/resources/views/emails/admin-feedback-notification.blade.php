...
<head>
    <meta charset="UTF-8">
    <title>Feedback mới - Sola Vietnam</title>
</head>
        ...
        <div style="max-width:680px;margin:0 auto;background:#0b1730;border:1px solid rgba(255,255,255,0.08);border-radius:24px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.35);">
            ...
            <div style="padding:28px 32px;background:linear-gradient(135deg,#0f1f42 0%, #102b5c 100%);border-bottom:1px solid rgba(255,255,255,0.08);">
                ...
                <h1 style="margin:10px 0 0;font-size:28px;line-height:1.3;color:#ffffff;">
                    Có feedback mới từ người dùng
                </h1>
                <p style="margin:10px 0 0;font-size:14px;line-height:1.7;color:#b9c8e8;">
                    Hệ thống vừa ghi nhận một đóng góp ý kiến mới từ website.
                </p>
            </div>
            ...
            <div style="padding:28px 32px;">
                <div style="margin-bottom:20px;padding:18px 20px;border-radius:18px;background:rgba(47,128,237,0.08);border:1px solid rgba(47,128,237,0.18);">
                    <div style="font-size:13px;color:#8fb8ff;margin-bottom:8px;">Mã feedback</div>
                    <div style="font-size:26px;font-weight:700;color:#ffffff;">#{{ $feedback->id }}</div>
                </div>

                <div style="margin-bottom:24px;">
                    <div style="font-size:15px;font-weight:700;color:#ffffff;margin-bottom:14px;">Thông tin người gửi</div>
                ...
                <div style="margin-bottom:24px;">
                    <div style="font-size:15px;font-weight:700;color:#ffffff;margin-bottom:14px;">Nội dung feedback</div>

                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);width:38%;font-size:14px;color:#8ea3c7;">Loại</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;">
                                {{ $feedback->type ?? 'Không có' }}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#8ea3c7;">Tiêu đề</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#ffffff;font-weight:700;">
                                {{ $feedback->title ?? 'Không có' }}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#8ea3c7;">Trạng thái</td>
                            <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:14px;color:#f59e0b;font-weight:700;">
                                {{ $feedback->status ?? 'pending' }}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:12px 0;font-size:14px;color:#8ea3c7;vertical-align:top;">Nội dung</td>
                            <td style="padding:12px 0;font-size:14px;color:#ffffff;white-space:pre-line;line-height:1.8;">
                                {{ $feedback->content ?? 'Không có' }}
                            </td>
                        </tr>
                    </table>
                </div>
